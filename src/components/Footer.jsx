      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 pb-10">
        ...
        <div className="grid md:grid-cols-12 gap-10 lg:gap-8">
          ...
          <div className="md:col-span-3">
            ...
            {/* Voci più alte e ravvicinate: da telefono erano alte 20px,
                sotto la soglia in cui il dito centra il link giusto. */}
            <ul className="space-y-1 text-sm">
              {navLinks.map(([label, href]) => (
                <li key={label}>
                  <Link
                    to={href}
                    className="group inline-flex items-center gap-2.5 py-2 text-text-secondary hover:text-text-primary transition-colors duration-300"
                  >
          ...
          <div className="md:col-span-4">
            ...
            <ul className="space-y-3 text-sm text-text-secondary">
              {/* Il contatto passa da Instagram, non più dall'email
                  personale: un indirizzo scritto in chiaro su una pagina
                  pubblica viene raccolto dai programmi che setacciano il
                  web e finisce nelle liste dello spam. */}
              <li>
                <a
                  href="https://www.instagram.com/netflaxt"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Scrivimi su Instagram, profilo @netflaxt"
                  className="group inline-flex items-center gap-3 px-4 py-2.5 rounded-lg border border-border bg-bg-surface/50 text-text-secondary hover:text-accent hover:border-accent/50 hover:bg-accent/5 hover:-translate-y-0.5 transition-all duration-300"
                >
                  <svg
                    viewBox="0 0 24 24"
                  ...
                  <span className="font-semibold">Scrivimi su Instagram</span>
                  <span className="text-text-muted group-hover:text-accent/70 transition-colors duration-300">
                    @netflaxt
                  </span>
                </a>
              </li>
